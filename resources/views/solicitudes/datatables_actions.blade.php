...
@if($solicitud->puedeDespachar())
    ...
    <span data-toggle="tooltip" title="Despachar">
        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#otromodelId" >
        ...
        <div class="modal fade" id="otromodelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
             aria-hidden="true">
